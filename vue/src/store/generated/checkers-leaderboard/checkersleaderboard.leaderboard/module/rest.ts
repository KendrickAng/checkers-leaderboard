...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/checkers-leaderboard/leaderboard/board
   */
  queryBoard = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetBoardResponse, RpcStatus>({
      path: `/checkers-leaderboard/leaderboard/board`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/checkers-leaderboard/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/checkers-leaderboard/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/checkers-leaderboard/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/checkers-leaderboard/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/checkers-leaderboard/leaderboard/player_info/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/checkers-leaderboard/leaderboard/player_info/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
